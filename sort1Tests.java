public class sort1Tests {
   public static void main(String[] args) {
      int[] selectArr = {4,7,2,8,1,6,9,-2,8};

      System.out.println("Selection sort:");
      Sorts1.selectionSort(selectArr, selectArr.length);
      ...
      Sorts1.mergeSort(mergeArray, mergeArray.length);
      for (int i = 0; i < mergeArray.length; i++) {
         System.out.println(mergeArray[i]);
      }
      System.out.println("Quick sort:"); 
      int[] quickArray = {0, 1, 7, 3, -1, 166, 9, -9, 0, 56, 3, 2};
      Sorts1.quickSort(quickArray, quickArray.length);
